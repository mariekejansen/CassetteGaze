 ...
 * This file demonstrates how to integrate Cassettegaze with a web frontend
 */

// For React/Vue/Angular applications
export class CassettegazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CassettegazeClient(provider, contractAddress);
