...
const contractABI = require("../artifacts/contracts/Cassettegaze.sol/Cassettegaze.json").abi;

program
    .name("cassettegaze-cli")
    .description("CLI tool for Cassettegaze smart contract")
    .version("1.0.0");
